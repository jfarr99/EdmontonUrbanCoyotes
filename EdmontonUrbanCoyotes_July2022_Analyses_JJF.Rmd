...
ggplot(bold.per.chsq.resids.long, aes(x = HumanConcern, y = Bold, fill = Resids)) +
  ...
  scale_fill_viridis("Pearson's Residuals",option = "rocket", na.value = "grey80", 
...
bold.concern.plot = 
  ...
  draw_plot_label(label = "Pearson's Residuals", x=0.93, y=0.25, size =16, color ="black",  fontface = "plain",
 angle = 90, hjust = 0, vjust = 0)

    save_plot("Figures/correlation.between.bold.concern.Nov202022.jpeg", bold.concern.plot, base_width = 6.5, base_height= 3)

    rm(bold.per.chsq.plot, bold.per.table, bold.per.chsq,bold.per.chsq.resids, bold.per.chsq.resids.long)
```
...
rm(bold.data.modelling, bold.model, bold.effect.plot)
```
...
rm(perc.model.dredge,  perc.models.list, perc.model.null)
```
...
plot(effects::Effect(focal.predictors=c("Residential", "Year"), perc.model.polr), rug = FALSE) # export this plot to a jpeg file

rm(perc.model, perc.model.polr)
```
...
save_plot("Figures/ordinal.regression.outputs.jpeg", ordinal.output.plot, base_width = 12, base_height= 6)
...
bold.time.plot = 
  ...
  scale_fill_viridis("Coyote Boldness", option = "inferno", alpha = 0.9, direction=-1, discrete = TRUE)+ 
...
perc.time.plot = 
  ...
  geom_bar(stat = "identity", position=position_dodge(), color = "black", alpha =0.8) +       
  geom_smooth( method = "lm", color = "black", fill="grey30", size = 1)+
  scale_fill_viridis("Human Concern", option = "inferno", alpha = 0.9, direction=-1, discrete = TRUE)+ 
        ylab(NULL)+ 
...
save_plot("Figures/boldness.concern.over.years.plot.Nov202022.jpeg", years.plot, base_width = 10, base_height= 10)
...
ggplot(bold.act.chsq.resids.long, aes(y = Act, x = Bold, fill = Resids)) +
  ...
  scale_fill_viridis("Residuals",option ="rocket", alpha = 0.9,na.value = "grey80", limits =c(-11,19), breaks=c(-10,0,18), labels=c(-10, 0,18),  direction=-1)+ 
...
ggplot(bold.vul.chsq.resids.long, aes(y = Vul, x = Bold, fill = Resids)) +
  geom_tile() + geom_text(size = 6, color = "white", aes(label = sig)) + 
  #scale_fill_viridis(option = "turbo", direction = -1, limits = c(-20,20)) +
 scale_fill_viridis("Residuals",option ="rocket",alpha = 0.9, na.value = "grey80", limits =c(-18,18.5), direction=-1)+ 
...
bold.leash.chsq.plot=
  ...
  geom_tile() + geom_text(aes(label = sig), size = 6, color="white") + ylab("Leash\nStatus") + xlab(NULL)+
  scale_fill_viridis("Residuals",option ="rocket",alpha = 0.9, na.value = "grey80", limits =c(-10,11), breaks  = c(-10,0,10), labels = c(-10,0,10), direction=-1)+ 
  #scale_fill_viridis(option = "turbo", direction = -1, limits = c(-20,20)) +
  theme_bw() + 
    scale_x_discrete(expand =c(0,0))+ scale_y_discrete(expand = c(0,0))+
  theme(legend.position = "none", 
...
ggplot(bold.num.chsq.resids.long, aes(y = Num, x = Bold, fill = Resids)) +
 ...
 # scale_fill_viridis(option = "turbo", direction = -1, limits = c(-20,20)) +
  ylab("Coyote\nNumber") + xlab(NULL) + 
   scale_fill_viridis(option ="rocket",alpha = 0.9, na.value = "grey80", limits =c(-7,7.5), breaks = c(-7,0,7), labels = c(-7, 0, 7), direction=-1)+ 
  theme_bw() + 
    scale_x_discrete(expand =c(0,0))+ scale_y_discrete(expand = c(0,0))+
  theme(legend.position = "none", 
        axis.text.x = element_blank(),
...
ggplot(bold.health.chsq.resids.long, aes(y = Health, x = Bold, fill = Resids)) +
  geom_tile()+ geom_text(aes(label = sig), size = 6, color = "white") + ylab("Coyote\nHealth") + xlab(NULL) + 
  #scale_fill_viridis("Residuals", option = "turbo", direction = -1, limits = c(-20,20)) + 
   scale_fill_viridis(option ="rocket",alpha = 0.9, na.value = "grey80", limits =c(-11,12.5), breaks = c(-11,0,12), labels = c(-11, 0, 12), direction=-1)+ 
  theme_bw() + 
  scale_x_discrete(expand =c(0,0))+ scale_y_discrete(expand = c(0,0))+
...
ggplot(perc.act.chsq.resids.long, aes(y = Act, x = Perc, fill = Resids)) +
  ...
  #scale_fill_viridis("Residuals", option = "turbo", direction = -1,limits = c(-15,15)) +
   scale_fill_viridis("Residuals",alpha = 0.9, option ="rocket", na.value = "grey80", limits =c(-11,19), breaks=c(-10,0,18), labels=c(-10, 0, 18), direction=-1)+ 
...
ggplot(perc.vul.chsq.resids.long, aes(y = Vul, x = Perc, fill = Resids)) +
 ...
 # scale_fill_viridis(option = "turbo", direction = -1,limits = c(-15,15)) +
  ylab(NULL)+ xlab(NULL)+
 scale_fill_viridis("Residuals",alpha = 0.9, option ="rocket", na.value = "grey80", breaks=c(-18,0,18), labels=c(-18, 0,18), limits = c(-18, 18.5), direction=-1)+ 
   theme_bw()+ 
  scale_x_discrete(expand =c(0,0))+ scale_y_discrete(expand = c(0,0))+
...
perc.leash.chsq.plot=
  ...
  geom_tile() + geom_text(aes(label = sig), size = 6, color="white") + ylab(NULL) + xlab(NULL)+
 # scale_fill_viridis(option = "turbo", direction = -1,limits = c(-15,15)) + 
  scale_fill_viridis(alpha = 0.9,option ="rocket", na.value = "grey80",  limits =c(-10,11), breaks  = c(-9,0,10), labels = c(-9,0,10), direction=-1)+ 
  theme_bw() + 
  scale_x_discrete(expand =c(0,0))+ scale_y_discrete(expand = c(0,0))+
  theme(axis.text = element_blank(), axis.ticks = element_blank(), legend.position = "right",
        legend.text = element_text(size = 14), legend.title = element_blank(), 
...
perc.num.chsq.plot = 
  ...
  geom_tile() + geom_text(aes(label = sig), size = 6,color="white") +
   scale_fill_viridis(alpha = 0.9,option ="rocket", na.value = "grey80", limits =c(-7,7.5), breaks = c(-7,0,7), labels = c(-7, 0, 7), direction=-1)+ 
...
perc.health.chsq.plot=
  ...
  geom_tile() + geom_text(aes(label = sig), size = 6, color="white") + ylab(NULL) + xlab(NULL)+
   scale_fill_viridis(alpha = 0.9, option ="rocket", na.value = "grey80", limits =c(-11,12.5), breaks = c(-10,0,12), labels = c(-10, 0, 12), direction=-1)+ 
#  scale_fill_viridis("Residuals", option = "turbo", direction = -1, limits = c(-15,15)) +
  theme_bw() + 
  scale_x_discrete(expand =c(0,0))+ scale_y_discrete(expand = c(0,0))+
  theme(axis.text = element_blank(), axis.ticks = element_blank(), 
...
save_plot("Figures/context.plot.nov202022.jpeg", context.plot, base_width = 10, base_height= 10)
